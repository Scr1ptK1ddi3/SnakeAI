...
import {KeyboardEventDispatcher} from "./inputController/KeyboardEventDispatcher";

export class GameEngine {
    private readonly _keyboardEventDispatcher: KeyboardEventDispatcher = new KeyboardEventDispatcher(window);
    ...
    private constructor (xLength: number, yLength: number, snakeLength: number) {
        ...
        this._keyboardEventDispatcher.callbackFunction = this.defaultCallbackFunc;
    ...
    private defaultCallbackFunc(event: KeyboardEvent): void {
    ...
    initializeHumanController (): void {
        this._controller = new HumanInputController(this._snake.head);
